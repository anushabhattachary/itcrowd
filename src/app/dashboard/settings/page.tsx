...
<<<<<<< HEAD
          <section className="bg-[#FFFFFF] border border-white/5 rounded-2xl p-6 shadow-xl space-y-6">
            ...
            <p className="text-xs text-[#8A7F6E]">List of locations where creators are permitted to visit and shoot materials.</p>
...
<<<<<<< HEAD
          <section className="bg-gradient-to-r from-[#FFFFFF] to-[#FBF6EF] border border-brand-purple/20 rounded-2xl p-6 shadow-xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative overflow-hidden">
            <div className="space-y-1 relative z-10">
              ...
              <p className="text-xs text-[#8A7F6E]">Custom plan: Up to 5 campaigns, NIL Athletes connection, and professional photo/video shoots.</p>
            </div>
            <div className="text-right shrink-0 relative z-10 bg-[#F3EBE0] border border-white/10 p-4 rounded-xl">
