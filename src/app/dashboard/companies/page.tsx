    ...
    <div className="space-y-6">
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium text-[#8A7F6E]">Contact Name *</label>
            <input required {...register("founder_name")} className="w-full bg-[#F3EBE0] border border-white/10 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-brand-purple focus:ring-1 focus:ring-brand-purple" />
          </div>
